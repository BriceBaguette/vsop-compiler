...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::LOWEREQUAL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::LOWEREQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_STRINGID (location_type l)
      {
        return symbol_type (token::STRINGID, std::move (l));
      }
#else
      static
      symbol_type
      make_STRINGID (const location_type& l)
      {
        return symbol_type (token::STRINGID, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_OBJECTIDENTIFIER (const std::string& v, const location_type& l)
      {
        return symbol_type (token::OBJECTIDENTIFIER, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TYPEIDENTIFIER (std::string v, location_type l)
      {
        return symbol_type (token::TYPEIDENTIFIER, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_TYPEIDENTIFIER (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TYPEIDENTIFIER, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
